...
export default function RecipesPage() {
  ...
  return (
    <main style={{ maxWidth: 1120, margin: "0 auto", padding: "40px 24px" }}>
      ...
      <p>
        Explore individual products and bundles, their required operations, and
        the evidence available for planning.
      </p>
        ...
        <>
          ...
          <label>
            ...
            >
              {[
                "All categories",
                ...new Set(gallery.recipes.map((recipe) => recipe.category)),
              ].map((value) => (
          ...
          {!gallery.recipes.length && (
            <p>
              No validated catalog has been activated. Imported products become
              recipes only after their requirements and evidence are supplied.
            </p>
          )}
          <div
            style={{
