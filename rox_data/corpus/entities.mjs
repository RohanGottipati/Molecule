...
export const MERCHANTS = [
    ...
    contacts: [
      {
        ...
        email: "mc.bouchard@threadforge.ca",
        role: "Production Lead",
        lang: "fr",
      },
      {
        name: "Dev Patel",
        email: "dev@threadforge.ca",
  ...
  },
  {
    ...
    contacts: [
      {
        name: "Dana Okonkwo",
        email: "dana@stitchworks.example",
        role: "Owner",
        lang: "en",
      },
    ],
  ...
  },
  {
    ...
    capabilities: [
      {
        id: "cap-needle-embroidery",
        label: "Logo embroidery backup",
        noun: "embroidery",
        unit: "pieces",
        capacity: 300,
        period: "day",
  ...
  },
  {
    ...
    capabilities: [
      {
        id: "cap-laser-engraving",
        label: "Individual name engraving",
        noun: "engraving",
        unit: "bottles",
        capacity: 400,
        period: "day",
  ...
  },
  {
    ...
    capabilities: [
      {
        id: "cap-pack-assembly",
        label: "Individual kit packaging",
        noun: "assembly",
        unit: "kits",
        capacity: 600,
        period: "day",
      ...
      {
        id: "cap-pack-fulfillment",
        label: "Canadian kit fulfillment",
        noun: "fulfilment",
        unit: "kits",
        capacity: 600,
        period: "day",
  ...
  },
  {
    ...
    capabilities: [
      {
        id: "cap-base-hoodie",
        label: "Premium black cotton hoodie",
        noun: "hoodies",
        unit: "hoodies",
        capacity: 1000,
        period: "week",
      ...
      {
        id: "cap-base-bottle",
        label: "Black stainless steel bottle",
        noun: "bottles",
        unit: "bottles",
        capacity: 1000,
        period: "week",
...
export const ALL_CAPS = MERCHANTS.flatMap((m) =>
  m.capabilities.map((c) => ({ ...c, merchant: m })),
);
...
export function aliasTable() {
  ...
  for (const m of MERCHANTS) {
    ...
    for (const a of m.aliases)
      rows.push({ alias: a, kind: "merchant", resolved: m.id });
    if (m.store)
      rows.push({ alias: m.store, kind: "merchant", resolved: m.id });
    if (m.legacyId)
      rows.push({ alias: m.legacyId, kind: "merchant", resolved: m.id });
  }
  return rows;
}
